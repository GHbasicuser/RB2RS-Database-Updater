...
'db-update.vbs v°1.02 (07/05/2022) par GHbasicuser (aka PhiliWeb)'
...
If FS.FileExists("Stations\Latest_RB2RS.zip") AND DateDiff("d", Fichier.DateLastModified, Now) > 30 Then 
Dim oShell
Set oShell = CreateObject("WScript.Shell")
oShell.Popup "RadioSure - The last successful update is more than 30 days old. (message generated by db-update.vbs)", 30
Set oShell=Nothing
End If        
Set Fichier = Nothing
